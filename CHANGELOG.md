...
- **Python code intelligence**: tree-sitter-python based analyzer extracts classes/functions (sync/async), properties/static/class methods, and resolves `import`/`from` dependencies (relative + absolute).
